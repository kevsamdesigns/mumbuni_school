...
const numberedFields = (prefix: string, count: number, fields: { suffix: string; label: string; type?: "text" | "textarea" }[]) =>
  Array.from({ length: count }, (_, index) =>
    fields.map((item) => field(`${prefix}.${index + 1}.${item.suffix}`, `${item.label} ${index + 1}`, item.type)),
  ).flat();
...
const CONTENT_SECTIONS: Record<string, { label: string; sections: { key: string; label: string; type: "text" | "textarea" }[] }> = {
  ...
  about: {
    label: "About Page",
    sections: [
      field("header.eyebrow", "Header Eyebrow"),
      field("header.title", "Header Title"),
      field("header.subtitle", "Header Subtitle", "textarea"),
      field("history.eyebrow", "History Eyebrow"),
      field("history.heading", "History Heading"),
      field("history.imageBadge", "History Image Badge"),
      field("history.body", "History Body", "textarea"),
      field("history.motto", "History Motto"),
      field("history.mottoBody", "History Motto Body", "textarea"),
      field("mission.title", "Mission Title"),
      field("mission.body", "Mission Body", "textarea"),
      field("vision.title", "Vision Title"),
      field("vision.body", "Vision Body", "textarea"),
      field("motto.title", "Motto Title"),
      field("motto.body", "Motto Body", "textarea"),
      field("leadership.eyebrow", "Leadership Eyebrow"),
      field("leadership.heading", "Leadership Heading"),
      field("leadership.body", "Leadership Body", "textarea"),
      field("deputy.academics.name", "Academic Deputy Name"),
      field("deputy.academics.role", "Academic Deputy Role"),
      field("deputy.academics.message", "Academic Deputy Message", "textarea"),
      field("deputy.admin.name", "Admin Deputy Name"),
      field("deputy.admin.role", "Admin Deputy Role"),
      field("deputy.admin.message", "Admin Deputy Message", "textarea"),
      field("staff.eyebrow", "Staff Eyebrow"),
      field("staff.heading", "Staff Heading"),
      field("staff.body", "Staff Body", "textarea"),
      ...numberedFields("staff", 4, [
        { suffix: "name", label: "Staff Name" },
        { suffix: "role", label: "Staff Role" },
        { suffix: "desc", label: "Staff Description", type: "textarea" },
      ]),
      field("story.eyebrow", "Story Eyebrow"),
      field("story.heading", "Story Heading"),
      field("story.body", "Story Body", "textarea"),
    ],
  },
  academics: {
    ...
    sections: [
      ...
      field("header.title", "Header Title"),
      field("header.subtitle", "Header Subtitle", "textarea"),
      field("overview.eyebrow", "Overview Eyebrow"),
      field("overview.heading", "Overview Heading"),
      field("overview.body", "Overview Body", "textarea"),
      field("levels.eyebrow", "Levels Eyebrow"),
      field("levels.heading", "Levels Heading"),
      ...numberedFields("grade", 3, [
        { suffix: "title", label: "Grade Title" },
        { suffix: "system", label: "Grade System" },
        { suffix: "desc", label: "Grade Description", type: "textarea" },
        { suffix: "pathways", label: "Grade Pathways", type: "textarea" },
      ]),
      field("departments.eyebrow", "Departments Eyebrow"),
      field("departments.heading", "Departments Heading"),
      ...numberedFields("department", 6, [
        { suffix: "title", label: "Department Title" },
        { suffix: "desc", label: "Department Description", type: "textarea" },
      ]),
    ],
  },
  admissions: {
    ...
    sections: [
      ...
      field("header.title", "Header Title"),
      field("header.subtitle", "Header Subtitle", "textarea"),
      field("requirements.eyebrow", "Requirements Eyebrow"),
      field("requirements.heading", "Requirements Heading"),
      field("requirements.body", "Requirements Body", "textarea"),
      field("requirements.documents.title", "Documents Title"),
      field("requirements.documents.items", "Documents Items", "textarea"),
      field("requirements.health.title", "Health Title"),
      field("requirements.health.items", "Health Items", "textarea"),
      field("requirements.effects.title", "Personal Effects Title"),
      field("requirements.effects.items", "Personal Effects Items", "textarea"),
      field("requirements.books.title", "Books Title"),
      field("requirements.books.items", "Books Items", "textarea"),
      field("fees.eyebrow", "Fees Eyebrow"),
      field("fees.heading", "Fees Heading"),
      field("fees.body", "Fees Body", "textarea"),
      field("fees.classHeader", "Fees Class Header"),
      field("fees.term1Header", "Fees Term 1 Header"),
      field("fees.term2Header", "Fees Term 2 Header"),
      field("fees.term3Header", "Fees Term 3 Header"),
      field("fees.totalHeader", "Fees Total Header"),
      ...numberedFields("fees", 4, [
        { suffix: "class", label: "Fee Class" },
        { suffix: "t1", label: "Fee Term 1" },
        { suffix: "t2", label: "Fee Term 2" },
        { suffix: "t3", label: "Fee Term 3" },
        { suffix: "total", label: "Fee Total" },
      ]),
      field("payment.heading", "Payment Heading"),
      field("payment.contactLabel", "Payment Contact Label"),
      field("payment.phone", "Payment Phone"),
      field("payment.referenceLabel", "Payment Reference Label"),
      field("payment.reference", "Payment Reference"),
      field("payment.steps", "Payment Steps", "textarea"),
      field("payment.chequeTitle", "Cheque Title"),
      field("payment.chequeBody", "Cheque Body", "textarea"),
      field("payment.officeTitle", "Office Title"),
      field("payment.officeBody", "Office Body", "textarea"),
      field("cta.contact", "Contact CTA"),
      field("cta.download", "Download CTA"),
      field("faq.eyebrow", "FAQ Eyebrow"),
      field("faq.heading", "FAQ Heading"),
      field("faq.body", "FAQ Body", "textarea"),
      ...numberedFields("faq", 4, [
        { suffix: "q", label: "FAQ Question" },
        { suffix: "a", label: "FAQ Answer", type: "textarea" },
      ]),
    ],
  },
  contact: {
    ...
    sections: [
      ...
      field("header.title", "Header Title"),
      field("header.subtitle", "Header Subtitle", "textarea"),
      field("phone.label", "Phone Label"),
      field("phone.value", "Phone Value"),
      field("email.label", "Email Label"),
      field("email.value", "Email Value"),
      field("address.label", "Address Label"),
      field("address.value", "Address Value", "textarea"),
      field("form.name", "Form Name Label"),
      field("form.namePlaceholder", "Form Name Placeholder"),
      field("form.email", "Form Email Label"),
      field("form.emailPlaceholder", "Form Email Placeholder"),
      field("form.phone", "Form Phone Label"),
      field("form.phonePlaceholder", "Form Phone Placeholder"),
      field("form.message", "Form Message Label"),
      field("form.messagePlaceholder", "Form Message Placeholder"),
      field("form.button", "Form Button"),
      field("toast.title", "Toast Title"),
      field("toast.body", "Toast Body", "textarea"),
      field("map.eyebrow", "Map Eyebrow"),
      field("map.heading", "Map Heading"),
      field("map.caption", "Map Caption", "textarea"),
    ],
  },
  news: {
    label: "News Page",
    sections: [
      ...
      field("header.title", "Header Title"),
      field("header.subtitle", "Header Subtitle", "textarea"),
      ...numberedFields("item", 4, [
        { suffix: "title", label: "News Title" },
        { suffix: "date", label: "News Date" },
        { suffix: "desc", label: "News Description", type: "textarea" },
      ]),
    ],
  },
  rules: {
    ...
    sections: [
      ...
      field("header.title", "Header Title"),
      field("header.subtitle", "Header Subtitle", "textarea"),
      field("intro.eyebrow", "Intro Eyebrow"),
      field("intro.heading", "Intro Heading"),
      field("intro.body", "Intro Body", "textarea"),
      field("rule.labelPrefix", "Rule Label Prefix"),
      ...numberedFields("rule", 7, [
        { suffix: "title", label: "Rule Title" },
        { suffix: "desc", label: "Rule Description", type: "textarea" },
      ]),
      field("note.title", "Note Title"),
      field("note.body", "Note Body", "textarea"),
    ],
  },
  transport: {
    ...
    sections: [
      ...
      field("overview.heading", "Overview Heading"),
      field("overview.body", "Overview Body", "textarea"),
      field("features.heading", "Features Heading"),
      ...numberedFields("feature", 4, [
        { suffix: "title", label: "Feature Title" },
        { suffix: "desc", label: "Feature Description", type: "textarea" },
      ]),
    ],
  },
  careers: {
    ...
    sections: [
      ...
      field("header.title", "Header Title"),
      field("header.subtitle", "Header Subtitle", "textarea"),
      ...numberedFields("benefit", 3, [
        { suffix: "title", label: "Benefit Title" },
        { suffix: "desc", label: "Benefit Description", type: "textarea" },
      ]),
      field("openings.eyebrow", "Openings Eyebrow"),
      field("openings.heading", "Openings Heading"),
      field("openings.body", "Openings Body", "textarea"),
      ...numberedFields("job", 4, [
        { suffix: "title", label: "Job Title" },
        { suffix: "type", label: "Job Type" },
        { suffix: "location", label: "Job Location" },
        { suffix: "desc", label: "Job Description", type: "textarea" },
      ]),
      field("job.apply", "Job Apply Button"),
      field("form.eyebrow", "Form Eyebrow"),
      field("form.heading", "Form Heading"),
      field("form.fullName", "Form Full Name Label"),
      field("form.fullNamePlaceholder", "Form Full Name Placeholder"),
      field("form.email", "Form Email Label"),
      field("form.emailPlaceholder", "Form Email Placeholder"),
      field("form.phone", "Form Phone Label"),
      field("form.phonePlaceholder", "Form Phone Placeholder"),
      field("form.position", "Form Position Label"),
      field("form.positionPlaceholder", "Form Position Placeholder"),
      field("form.experience", "Form Experience Label"),
      field("form.experiencePlaceholder", "Form Experience Placeholder"),
      field("form.cover", "Form Cover Letter Label"),
      field("form.coverPlaceholder", "Form Cover Letter Placeholder", "textarea"),
      field("form.cv", "Form CV Label"),
      field("form.cvPlaceholder", "Form CV Placeholder"),
      field("form.cvHelp", "Form CV Help Text", "textarea"),
      field("form.submit", "Form Submit Button"),
      field("toast.title", "Toast Title"),
      field("toast.body", "Toast Body", "textarea"),
    ],
  },
...
const AdminDashboard = () => {
  ...
  useEffect(() => { document.title = "Admin Dashboard | Mumbuni Boys Senior School"; }, []);
